...
export const MaidenName = ({ sortValue, setUsers, setLimit, setTotalUsers }) => {
    ...
    return (
        <div className="maidenName" ref={maidenNameRef}
            ...
            MaidenName
            <img src="./images/dropdown.svg" alt="dropdown" width='22px' className={`maidenName__icon ${isMenuOpenMaidenName ? 'maidenName__icon--rotated' : ''
            ...
            <div className={`maidenName__menu ${isMenuOpenMaidenName ? 'maidenName__menu--visible' : ''
                ...
                <div className="search">
                    ...
                    <div className="search__btn"><img src="./images/search.svg" alt="search" width='14px' onClick={() => searchByMaidenName(maidenName)} /></div>
                </div >
